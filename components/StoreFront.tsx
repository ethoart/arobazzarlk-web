        ...
        <div className="animate-fade-in">
            ...
            <div className="bg-white dark:bg-[#0a0a0a] text-gray-900 dark:text-white border-t border-gray-100 dark:border-gray-800 py-20 px-6 rounded-t-[3rem] -mb-20 relative z-10 transition-colors">
                <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12 text-center">
                    ...
                    <div className="flex flex-col items-center gap-4"><div className="w-16 h-16 rounded-2xl bg-gray-50 dark:bg-gray-900/50 flex items-center justify-center text-purple-600 dark:text-purple-400 mb-2"><CreditCard size={32} /></div><h4 className="text-xl font-bold">Multiple Payment Methods</h4><p className="text-gray-500 dark:text-gray-400 text-sm max-w-xs">We support various secure payment options including Cards.</p></div>
